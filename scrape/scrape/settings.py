...
SECRET_KEY = 'django-insecure-y5b5^w+uggb3zxo(snzg@30+x8-%a3a(92xebbx%jgs4ol!srj'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            'C:/Users/ingra/Documents/EF-Routing/ef_routing-backend/scrape/scraping/templates'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
